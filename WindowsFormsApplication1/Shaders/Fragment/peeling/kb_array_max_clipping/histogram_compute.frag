#include "define.h"
	...
	float getPixelFragDepthMin		(									) {return uintBitsToFloat (	imageLoad	 (image_count_sem_min_max, ivec3(gl_FragCoord.xy, 2)).r);}
	float getPixelFragDepthMax		(									) {return uintBitsToFloat (	imageLoad	 (image_count_sem_min_max, ivec3(gl_FragCoord.xy, 3)).r);}
