#include "define.h"
	...
	uint getPixelFragDepthMin		(					) {return imageLoad (image_count_sem_min_max, ivec3(gl_FragCoord.xy, 2)).r;}
	uint getPixelFragDepthMax		(					) {return imageLoad (image_count_sem_min_max, ivec3(gl_FragCoord.xy, 3)).r;}
